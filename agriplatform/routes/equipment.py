...
from agriplatform.forms.equipment_form import EquipmentForm
from agriplatform.forms.availability_form import AvailabilityForm
from agriplatform.forms.booking_form import BookingForm
from agriplatform.forms.log_form import MaintenanceForm
