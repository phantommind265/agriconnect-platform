...
from app.forms.agrishare import JoinSessionForm
from app.forms.agrishare_upload import UploadFileForm
from flask_login import current_user, login_required
from app.forms.agrishare_create import CreateShareSessionForm

UPLOAD_FOLDER = os.path.join("app", "static", "uploads", "agrishare")
...
def create_share_session():
    ...
    #current_user.id = session['current_user']
